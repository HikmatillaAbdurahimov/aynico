...
with psycopg2.connect(database=os.getenv('database'),
    ...
    with conn.cursor() as cur:
        ...
        async def search_table():
            await asyncio.sleep(5)
            search_cars_query="""
            select car_name,car_number from cars where  car_name like '%i%';"""
        ...
        async def start():
          await asyncio.gather(create_table(),insert_table(),select_table(),alter_table(),update_table(),search_table(),delete_table())
